...
//            LocationListener thing = new LocationListener(new AssumeEverythingIsYesCheckPermissionProvider(), NullExceptionService, scheduler);

//            listener.Setup(x => x.PositionChanged())
